                            ...
                            <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-center">
                                    <button
                                        ...
                                        onClick={() =>
                                            openModal("Sent Queries", item.sentQueryDetails)
                                        }
                                    >
                                ...
                                <td className="border border-gray-300 px-4 py-2 text-center">
                                    <button
                                        ...
                                        onClick={() =>
                                            openModal("Received Queries", item.receivedQueryDetails)
                                        }
                                    >
                            ...
                            <table className="min-w-full table-auto">
                                ...
                                <tbody>
                                    {modalData.queryIds.map((query, idx) => {
                                        const formattedDate = new Date(query.assignedDate).toLocaleDateString(
                                            "en-GB",
                                        ...
                                        return (
                                            <tr key={idx} className="border-t">
                                                <td className="px-4 py-2">{query.studentName}</td>
