...
export default function QueryReport({ initialFilters } = {}) {
  ...
  useEffect(() => {
     if (!adminData) return;
    fetchFilteredData();
  }, [referenceId, studentName, suboption, fromDate, adminData, toDate, admission, grade, reason, location, city, assignedName, assignedFrom, userName, showClosed, page, limit]);

  // Reset to first page when filters change
  useEffect(() => {
    setPage(1);
  }, [referenceId, studentName, suboption, fromDate, adminData, toDate, admission, grade, reason, location, city, assignedName, assignedFrom, userName, showClosed]);
